...
public class ScreenUT : MonoBehaviour
{
    #region Fields
    ...
    public static void Initialize()
    {
        ...
        screenRight = lowerLeftCornerWorld.x;
        screenLeft = upperRightCornerWorld.x;
        screenBottom = upperRightCornerWorld.y;
        screenTop = lowerLeftCornerWorld.y;
    }
